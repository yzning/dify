...
from core.model_runtime.model_providers.lixiang._common import _CommonLixiangOpenAI
from core.model_runtime.utils import helper

logger = logging.getLogger(__name__)


class LixiangLargeLanguageModel(_CommonLixiangOpenAI, LargeLanguageModel):
    """
    ...
    def validate_credentials(self, model: str, credentials: dict) -> None:
        ...
        try:
            ...
            gwtoken = credentials.get("X-CHJ-GWToken")
            headers = {
                'Content-Type': 'application/json',
                'Accept-Charset': 'utf-8',
                "model": model,
                "X-CHJ-GWToken": gwtoken,
                "BCS-APIHub-RequestId": str(request_id)
            }
